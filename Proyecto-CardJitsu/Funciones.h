...
void CartasJugadasJugadorCpu(int Puntos_Jugador[], string elemento[], string color[],int cont_jugadores, int numero[], bool mazo[], int mano_jugador[], int mano_cpu[], int cantidad_cartas, int desafios_elegidos[], int cont_desafios[], bool navegacion[], int hitos_partida[]);
...
int ElGanadorEs(int Puntos_Jugador[], std::array<int,2>  carta_seleccionada,int cont_jugadores,int mano_jugador[],int mano_cpu[],string elemento[], string color[], int numero[], int desafios_elegidos[]);
...
void JugarRondaMenu(int Puntos_Jugador [], string elemento[], string color[], int cont_jugadores, int numero[], bool mazo[], int mano_jugador[], int mano_cpu[], int desafios_elegidos[], string descripciones_cartas_desafio[], int cont_desafios[], int cantidad_cartas, bool navegacion[],  int hitos_partida[], string nombre_jugador[]);
