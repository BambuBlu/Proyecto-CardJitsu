...
void ComparativaCartasJugadas(std::array<int,2>  carta_seleccionada, int Puntos_Jugador[],int cont_jugadores, int mano_jugador[], int mano_cpu[], string elemento[], string color[], int numero[], string elemento1, string elemento2);
