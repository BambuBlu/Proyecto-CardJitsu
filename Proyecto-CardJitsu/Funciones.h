...
void CpuVsCpu();
void ColocarMazo(bool mazo[], int mano_jugador1[], int mano_jugador2[], bool cartas_desafio[], int cont_desafios[], bool navegacion[]);
...
void CartasJugadasJugadorCpu(string elemento[], string color[], int Puntos_Jugador[],int cont_jugadores, int numero[], bool mazo[], int mano_jugador[], int mano_cpu[], int cantidad_cartas, int desafios_elegidos[], int cont_desafios[], bool navegacion[]);
...
void JugarRondaMenu(string elemento[], string color[],int Puntos_Jugador[], int cont_jugadores, int numero[], bool mazo[], int mano_jugador[], int mano_cpu[], int desafios_elegidos[], string descripciones_cartas_desafio[], int cont_desafios[], int cantidad_cartas, bool navegacion[]);
void MostrarCartasEnfrentadas(std::array<int,2>  carta_seleccionada, string elemento[], string color[], int numero[]);
