...
void CartasJugadasJugadorCpu(string elemento[], string color[],int cont_jugadores, int numero[], bool mazo[], int mano_jugador[], int mano_cpu[], int cantidad_cartas, int desafios_elegidos[], int cont_desafios[], bool navegacion[], int hitos_partida[], bool cartas_desafio_ganadas[]);
...
void JugarRondaMenu(string elemento[], string color[], int cont_jugadores, int numero[], bool mazo[], int mano_jugador[], int mano_cpu[], int desafios_elegidos[], string descripciones_cartas_desafio[], int cont_desafios[], int cantidad_cartas, bool navegacion[],  int hitos_partida[], string nombre_jugador[], bool cartas_desafio_ganadas[]);
